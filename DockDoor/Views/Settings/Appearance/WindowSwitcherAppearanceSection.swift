    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                if windowSwitcherScrollDirection == .horizontal {
                    Toggle(isOn: $dynamicSwitcherMaxRows) {
                        Text("Dynamic (Max Available Height)")
                    }
                    .settingsSearchTarget("appearance.dynamicSwitcherMaxRows")
                }
                ...
                .disabled(windowSwitcherScrollDirection == .horizontal && dynamicSwitcherMaxRows)
